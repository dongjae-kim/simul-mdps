...
import simulation_gen_task_meta_RL_GM as sim
import analysis
...
MODEL_LIST_IDF = 7 # 0 : MB ONLY, 1 : MF ONLY, 2 : LEE2014, 3 : ZPE MODEL.
if MODEL_LIST_IDF == 0:
    PARAMETER_FILE='regdata_mb.csv'
elif MODEL_LIST_IDF == 1:
    PARAMETER_FILE='regdata_mf.csv'
...
SIMUL_BEHAV_DIR = 'simul_results_putsout/'
TASK_IDF=0
if TASK_IDF == 0:
    SIMUL_BEHAV_DIR = 'simul_results_putsout/' + 'T1/'
elif TASK_IDF == 1:
    SIMUL_BEHAV_DIR = 'simul_results_putsout/' + 'T2/'
elif TASK_IDF == 2:
    SIMUL_BEHAV_DIR = 'simul_results_putsout/' + 'T3/'
elif TASK_IDF == 3:
    SIMUL_BEHAV_DIR = 'simul_results_putsout/' + 'T4/'
try:
...
if __name__ == '__main__':
    ...
    # make folder to save
    SIMUL_BEHAV_DIR = 'simul_results_putsout/T' + str(TASK_IDF) + '/'
    try:
        os.mkdir(SIMUL_BEHAV_DIR)
    except:
        ''
